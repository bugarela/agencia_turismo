...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { cliente_id: @compra.cliente_id, pacote_id: @compra.pacote_id } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { cliente_id: @compra.cliente_id, pacote_id: @compra.pacote_id } }
